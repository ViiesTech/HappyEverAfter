...
const SignUp2 = ({route, navigation}) => {
            ...
            <StyledContainer>
              ...
              <Card style={styles.input}>
                ...
                <View
                  ...
                  {profileImage ? (
                    <TouchableOpacity style={{borderRadius:20}} onPress={selectAnImage}>
                      <Image
              ...
              <Card style={styles.switcher}>
                <LinearGradient
                  ...
                  colors={male ? ['orange', 'red'] : ['#ffffff', '#ffffff']}
                  style={[
                    styles.male,
                    styles.buttonShadow,
                    {borderRadius: male ? 100 : 10},
                  ]}>
                  <StyledButtonTouch
                    style={{width: wp('42%'), backgroundColor: 'transparent'}}
                    onPress={() => {
                      setFemale(false), setMale(true), setGender('male');
                    }}>
                    <TextSmall
                      style={{
                        color: male ? '#ffffff' : '#F2B3B7',
                        fontWeight: 'bold',
                      }}>
                      Male
                    </TextSmall>
                ...
                <LinearGradient
                  ...
                  colors={female ? ['red', 'orange'] : ['#ffffff', '#ffffff']}
                  style={[
                    styles.female,
                    styles.buttonShadow,
                    {borderRadius: female ? 100 : 10},
                  ]}>
                  <StyledButtonTouch
                    style={{width: wp('42%'), backgroundColor: 'transparent'}}
                    onPress={() => {
                      setFemale(true), setMale(false), setGender('female');
                    }}>
                    <TextSmall
                      style={{
                        color: female ? '#ffffff' : '#F2B3B7',
                        fontWeight: 'bold',
                      }}>
                      Female
                    </TextSmall>
  ...
  return (
    <ImageBackground style={{flex: 1, padding: 15}} source={Images.signup2}>
